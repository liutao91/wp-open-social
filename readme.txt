...
Tags: 社交, 登录, 登陆, 分享, 微博, 微信, 谷歌, X, social, share, qq, weibo, wechat, google, facebook, x
License: MIT License

使用 QQ、微信、微博、谷歌、GitHub、X 等社交平台实现一键登录和分享。模块化结构，按需扩展，代码开源。Login and Share with social networks: QQ, WeiBo, Weixin, WeChat, Google, GitHub, X, Facebook.
...
1. 主要功能：QQ、微博、微信、谷歌、GitHub、Facebook、X 等登录和分享
